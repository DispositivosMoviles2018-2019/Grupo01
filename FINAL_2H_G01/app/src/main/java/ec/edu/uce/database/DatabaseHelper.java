...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_RESERVA=
            "CREATE TABLE " + Tablas.RESERVA.NOMBRE_TABLA
                    ...
                    + Tablas.RESERVA.COL_PLACA + " TEXT , "
                    + Tablas.RESERVA.COL_NUMERO_RESERVA + " INTEGER UNIQUE, "
                    + Tablas.RESERVA.COL_EMAIL + " TEXT , "
                    + Tablas.RESERVA.COL_CELULAR + " TEXT , "
                    + Tablas.RESERVA.COL_VALOR + " INTEGER , "
                    + Tablas.RESERVA.COL_FECHA_PRESTAMO + " TEXT , "
                    + Tablas.RESERVA.COL_FECHA_ENTREGA + " TEXT"
                    + ")";

    private static final String SQL_DELETE_RESERVA=
            "DROP TABLE IF EXISTS " + Tablas.RESERVA.NOMBRE_TABLA;
}
